...
.. warning :: 
    * The use of ``PAR REC`` files for image conversion should be discouraged as this is not an archival format (as most of the necessary metadata is not written to file). See this `link <https://github.com/rordenlab/dcm2niix/issues/255>`_ for further details.
